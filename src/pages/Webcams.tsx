    ...
    <Layout showSidebar>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          {/* Info Section */}
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 bg-gradient-to-r from-slate-900 to-blue-900 border-slate-700 text-white">
              <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                  <div>
                    <div className="text-2xl font-bold text-blue-300 mb-1">16</div>
                    <div className="text-sm text-slate-200">Webcam Attive</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-blue-300 mb-1">24/7</div>
                    <div className="text-sm text-slate-200">Streaming Live</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-blue-300 mb-1">HD</div>
                    <div className="text-sm text-slate-200">Qualità Video</div>
                  </div>
                </div>
              </div>
            </Card>
