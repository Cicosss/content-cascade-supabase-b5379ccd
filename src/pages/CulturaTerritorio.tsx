...
const CulturaTerritorio = () => {
  ...
  return (
    <Layout showSidebar={true}>
      <div className="bg-gradient-to-r from-blue-600 via-purple-500 to-indigo-600 text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold mb-4">🏛️ Cultura & Territorio</h1>
          <p className="text-xl text-blue-100">
            Immergiti nella storia, nell'arte e nelle tradizioni del territorio romagnolo
          </p>
        </div>
      </div>
...
export default CulturaTerritorio;
