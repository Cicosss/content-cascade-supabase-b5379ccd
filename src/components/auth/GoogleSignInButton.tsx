...
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ disabled = false }) => {
  ...
  return (
    <Button
      ...
      className="w-full bg-white hover:bg-gray-50 border-gray-300 text-gray-700 font-medium py-3 transition-colors duration-200"
    >
      <div className="flex items-center justify-center space-x-3">
        ...
        <span>
          {isLoading ? 'Connessione in corso...' : 'Continua con Google'}
        </span>
      </div>
    </Button>
  );
