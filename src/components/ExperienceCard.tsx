  ...
  return (
    ...
    >
      <Card className="bg-white border border-gray-200 mobile-shadow hover:shadow-md transition-shadow duration-300 group overflow-hidden">
        ...
        <CardContent className={getContainerPadding()}>
          ...
          <div className="flex items-center justify-between">
            ...
            {rating && (
              <div className="flex items-center">
                <span className={`text-yellow-500 ${getMobileTypography('text-sm')}`}>★</span>
                <span className={`${getMobileTypography('text-sm')} text-gray-600 ml-1`}>{rating}</span>
              </div>
            )}
          </div>
        </CardContent>
