...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      style={{ zIndex: 52 }} // Inline z-index for portalized content
      className={cn(
        "z-dropdown min-w-[8rem] overflow-hidden rounded-md border bg-slate-900 p-1 text-slate-100 shadow-md",
