...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full z-navigation flex justify-center pointer-events-auto")} style={{ zIndex: 51 }}> 
