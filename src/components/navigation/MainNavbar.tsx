          ...
          <div className="lg:hidden">
            <Sheet open={isMobileMenuOpen} onOpenChange={handleMobileMenuChange}>
              ...
              <SheetContent 
                side="right"
                mobileNoOverlay
                className="w-[100vw] sm:w-[380px] md:w-[420px] lg:w-[480px] bg-white/95 md:bg-background/95 backdrop-blur-sm md:backdrop-blur-md border-l border-white/10 overflow-y-auto text-foreground"
                data-mobile-menu="true"
              >
