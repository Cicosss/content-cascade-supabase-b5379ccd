...
export const HomepageNavbar: React.FC = React.memo(() => {
  ...
  return (
    <>
      {/* Navigation Bar */}
      <div className="homepage-navbar homepage-navbar-glass bg-white/20 flex h-16 md:h-20 lg:h-24 items-center px-4 md:px-6 lg:px-10 xl:px-16 max-w-full mx-auto relative z-10 transition-all duration-300 ease-in-out">
        {/* Logo */}
