...
export const MobileMenu: React.FC = () => {
  ...
  return (
    <Sheet open={isMobileMenuOpen} onOpenChange={setMobileMenuOpen}>
      ...
      <SheetContent side="left" className="pr-0 bg-gradient-to-br from-background via-card to-background border-border w-[85vw] max-w-80 z-dropdown overflow-y-auto relative">
