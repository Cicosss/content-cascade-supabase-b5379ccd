...
const HeroBackground: React.FC = () => {
  ...
  return (
    <div className={`absolute ${isMobile ? '-inset-[12px]' : '-inset-[2px]'} overflow-hidden bg-slate-900`}>
      ...
      <div className={`absolute ${isMobile ? '-inset-[12px]' : '-inset-[2px]'} bg-black/20 pointer-events-none`} />
    </div>
  );
};
