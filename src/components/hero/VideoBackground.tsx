          ...
          <div className={`absolute hero-unclamp ${isMobile ? '-inset-[12px]' : '-inset-[8px]'} overflow-hidden bg-slate-900`}>
            <iframe
              ...
              style={{
                ...
                top: '50%',
                left: '50%',
                width: isMobile ? '400vw' : '400vw',
                height: isMobile ? `${(viewportHeight || window.innerHeight) + 64}px` : '400vh',
                maxWidth: 'none',
                maxHeight: 'none',
                transform: isMobile ? 'translate(-48%, -51%) scale(1.08)' : 'translate(-48%, -50%) scale(1.05)',
                pointerEvents: 'none',
                border: 0,
                margin: 0,
                padding: 0,
